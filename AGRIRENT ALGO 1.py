    ...
    while True:
        ...
        while True:
            ...
            if len(nik) == 16 and nik.isdigit():
                ...
                clear()
                print(f"Username : {username_penyewa}")
                print(f"Password : {password_penyewa}")
                print("NIK harus berupa 16 digit angka. Silahkan coba lagi")
...
def login_penyewa():
    ...
    while True:
        ...
        if cek_loginpenyewa(username_penyewa, password_penyewa):
            print("Login berhasil sebagai Penyewa :D")
            while True:
                clear()
...
def beranda_penyewa(username_penyewa):
    ...
    while True:
        ...
        try:
            ...
            print("Opss, inputan anda salah, tolong masukkan input dalam bentuk angka")
            # clear()


# >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>LIHAT STOK & PENYEWAAN<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
def lihat_stok_barang(username_penyewa):
    ...
    while True:
        ...
        try:
            ...
            print("Maaf, inputan anda salah, tolong masukkan input dalam bentuk angka")
...
def sewa_barang(stok_barang, username_penyewa):
    if not stok_barang:
        print("Maaf, Stok barang tidak ditemukan:( ")
        return None

    while True:
        nama_barang = input("Masukkan nama barang yang ingin disewa: ").upper()
        if len(nama_barang) == 0: 
            print("Nama barang tidak boleh kosong. Silahkan coba lagi ")  
        elif nama_barang in stok_barang:  
            break  
        else:
            print("Maaf, Barang tidak ditemukan. Silahkan coba lagi ")  
    ...
    try:
        ...
        while True:
            try:
                ...
                print("Opss, format tanggal salah! Pastikan formatnya benar sesuai dengan DD-MM-YYYY.")
        ...
        while True:
            ...
            if len(username_input) == 0 or username_input.isspace():  
                print("Opss, Username tidak boleh kosong. Coba lagi.")
            elif username_input != username_penyewa: 
                print("Maaf, Username harus sama dengan username saat login. Silahkan coba lagi ")
            else:
        ...
        print("Maaf, Inputan anda tidak valid. Pastikan memasukkan angka dan format tanggal yang benar yaaa:) ")
    ...
    try:
        while True:
            ...
            if no_barang < 1 or no_barang > len(barang_disewa):
                print("Opss, Nomor yang anda masukkan tidak valid, silahkan coba lagi")
                continue
            else:
                break
        ...
        while True:
            try:
                ...
                if nominal < total_bayar:
                    print("Maaf nominal pembayaran kurang. Silakan coba lagi:) ")
                    continue
                break
            except ValueError:
        ...
        print("\nBarang berhasil dikembalikan. Terima kasih!^_^")
    except ValueError:
        print("Maaf tolong masukkan input dalam bentuk angka yang valid:) ")
...
def tambah_stok_barang():
    ...
    while True:
        ...
        if len(nama_barang) == 0 or nama_barang.isspace():  
            print("Maaf nama barang tidak boleh kosong.Silahkan Coba lagi.") 
        else:
            break  
    ...
    for row in barang:
        if len(row) >= 3 and row[0].lower() == nama_barang.lower():
            try:
                ...
                print("Opss, Input jumlah stok harus berupa angka. Silakan coba lagi.")
                return
    ...
    if not barang_ditemukan:
        try:
            ...
            print("Opss, Input harga dan stok harus berupa angka. Silakan coba lagi.")
            return
